...
class FillPermissionsForPaciente extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPaciente constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.paciente',
            'admin.paciente.index',
            'admin.paciente.create',
            'admin.paciente.show',
            'admin.paciente.edit',
            'admin.paciente.delete',
            'admin.paciente.bulk-delete',
        ]);
